 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  CKC_CTRL, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_LEAD,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \
...
void matrix_scan_user(void) {
   ...
   LEADER_DICTIONARY() {
     ...
     SEQ_TWO_KEYS(KC_E, KC_P) { SEND_STRING("atomaka@gmail.com"); }
   }
}
